...
extension ActivityCellView {
    ...
    func updateView(with configuration: ActivityCellViewConfiguration) {
        categoryImageView.image = UIImage(named: configuration.image)
        activityNameLabel.text = configuration.name
        activityInfoLabel.text = configuration.information
    }
}
